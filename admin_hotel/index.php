            ...
            <div class="sidebar">
                <nav id="main-menu" class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false" >
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link" name="menu" menucode="booking">
                                <i class="nav-icon bi bi-calendar-check"></i>
                                <p>Booking</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link" name="menu" menucode="housekeeping">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link" name="menu" menucode="function">
                                <i class="nav-icon bi bi-building"></i>
                                <p>Function Hall</p>
                            </a>
                        </li>
                        <li class="nav-item">
                               <a href="#" class="nav-link" name="menu" menucode="guest_accounts">
