...
<div class="d-flex justify-content-between align-items-center mb-2">
    <div>
        <h6 class="fw-bold mb-0">Premium Food Setup</h6>
        <p class="text-muted small mb-0">Premium tier food setup.</p>
    </div>
...
<script>
    ...
    function Premium_tier(page = 1) {
        ...
        $.post(
            "dirs/master_settings/dirs/food_config/actions/get_pagination_premium.php",
            {
                premiumCurrentPage,
                premiumPageSize,
                Search
                ...
                <tr class="align-middle" data-value="${premium.DocEntry}">
                    ...
                    <td class="text-center">
                        <span class="badge px-3 py-2 rounded-pill
                            ${premium.PackageStatus === "Available"
                                ? "bg-success-subtle text-success"
                                : "bg-danger-subtle text-danger"}">

                            ${premium.PackageStatus}
