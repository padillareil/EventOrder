<div class="justify-content-end mr-4 d-flex mt-2 gap-2">
	<div class="input-group border bg-light px-3 flex-grow-1" style="max-width: 300px;">
	    ...
	    <input type="search" id="search-snacks" class="form-control bg-transparent border-0 small py-2 shadow-none" placeholder="Search...">
	</div>
	...
	<div id="load_Snack_content"></div>
			...
			<div class="d-flex flex-column align-items-center text-muted py-5">
	           ...
	           <div class="small opacity-75">
	               Click the button 'Add Snacks' to create menu.
	           </div>
	       </div>
</div>