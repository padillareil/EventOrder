<div class="container my-5">
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        ...
        <div class="card-footer">
        	<button type="button" class="btn btn-secondary px-4 py-2 rounded-3 fw-medium">
                <span class="spinner-border spinner-border-sm d-none me-1" id="btn-spinner-account"></span>
				<span class="btn-text-account"><i class="bi bi-plus"></i> Admin</span>
            </button>
            <button type="button" class="btn btn-light px-4 py-2 rounded-3 fw-medium" onclick="viewAdmins()">
				<span class="btn-text-account">View Admins</span>
            </button>
        </div>
    </div>
</div>