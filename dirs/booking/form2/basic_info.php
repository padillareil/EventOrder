<div class="row g-2">
  <div class="col-12">
    ...
    <div class="input-group rounded-0 bg-white px-2 py-1 shadow-sm w-100">
      <textarea class="form-control bg-transparent  shadow-none py-0 small" id="event_title" rows="2" autocomplete="off" required></textarea>
    </div>
  </div>    
  ...
  <div class="col-6">
    ...
    <div class="input-group rounded-0 bg-white px-2 py-1 shadow-sm w-100">
      <span class="input-group-text bg-transparent  py-0 pe-2 text-muted"><i class="bi bi-calendar-event"></i></span>
      <input type="date" class="form-control shadow-none py-0 small" id="start_date" required>
    </div>
  </div>
  ...
  <div class="col-6">
    ...
    <div class="input-group rounded-0 bg-white px-2 py-1 shadow-sm w-100">
      <span class="input-group-text  py-0 pe-2 text-muted"><i class="bi bi-calendar-check"></i></span>
      <input type="date" class="form-control shadow-none py-0 small" id="end_date" required>
    </div>
  </div>
  ...
  <div class="col-6">
    ...
    <div class="input-group rounded-0 bg-white px-2 py-1 shadow-sm w-100">
      <span class="input-group-text  py-0 pe-2 text-muted"><i class="bi bi-clock"></i></span>
      <input type="time" class="form-control  shadow-none py-0 small" id="start_time" required>
    </div>
  </div>
  ...
  <div class="col-6">
    ...
    <div class="input-group rounded-0 bg-white px-2 py-1 shadow-sm w-100">
      <span class="input-group-text  py-0 pe-2 text-muted"><i class="bi bi-clock-history"></i></span>
      <input type="time" class="form-control shadow-none py-0 small" id="end_time" required>
    </div>
  </div>
  <div class="col-md-6">
  ...
  <div class="col-md-6">
    ...
    <div class="input-group rounded-3 bg-white px-2 py-1 shadow-sm w-100">
      <span class="input-group-text bg-transparent  py-0 pe-2 text-muted"><i class="bi bi-people-fill"></i></span>
      <input type="text" class="form-control bg-transparent  shadow-none py-0 small pax-input" id="expecte_pax" required>
    </div>
  </div>
  ...
  <div class="col-md-6">
    ...
    <div class="input-group rounded-3 bg-white px-2 py-1 shadow-sm w-100">
      <span class="input-group-text bg-transparent  py-0 pe-2 text-muted"><i class="bi bi-people-fill"></i></span>
      <input type="text" class="form-control bg-transparent  shadow-none py-0 small pax-input" id="guaranteed_pax" required>
    </div>
  </div>

  <div class="col-12 mt-4 mb-1-top pt-3">
  ...
  <div class="col-6">
    ...
    <select class="form-select form-select-lg bg-transparent shadow-none py-3 small" id="engager_category" required>
      <option value="Regular" selected>Regular - VIP</option>
  ...
  <div class="col-6">
    ...
    <div class="input-group rounded-0 bg-white px-2 py-1 shadow-sm w-100">
      <input type="text" class="form-control bg-transparent  shadow-none py-0 small" id="guest-name" autocomplete="off" required>
    </div>
  ...
  <div class="col-12">
    ...
    <div class="input-group rounded-0 bg-white px-2 py-1 shadow-sm w-100">
      <input type="text" class="form-control bg-transparent  shadow-none py-0 small" id="job_position" autocomplete="off">
    </div>
    <span class="text-danger">*</span>
  ...
  <div class="col-12">
    ...
    <div class="input-group rounded-0 bg-white px-2 py-1 shadow-sm w-100">
      <input type="text" class="form-control bg-transparent  shadow-none py-0 small" id="guest_company" autocomplete="off" required>
    </div>
  </div>
  ...
  <div class="col-12">
    ...
    <div class="input-group rounded-0 bg-white px-2 py-1 shadow-sm w-100">
      <input type="email" class="form-control bg-transparent  shadow-none py-0 small" id="guest_email" autocomplete="off" required>
    </div>
  </div>
  ...
  <div class="col-12">
    ...
    <div class="input-group rounded-0 bg-white px-2 py-1 shadow-sm w-100">
      <textarea class="form-control bg-transparent  shadow-none py-0 small" id="guest_address" rows="2" autocomplete="off" required></textarea>
    </div>
    <span class="text-danger">*</span>
