    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        ...
        <div class="card-body p-4 p-md-5 bg-white border-bottom">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
                <div>
                    <h5 class="fw-bold text-dark mb-1">Event Order</h5>
                    <p class="text-muted small mb-0">Track pipeline bookings, customer contract packages, and operational function status sheets.</p>
                </div>
