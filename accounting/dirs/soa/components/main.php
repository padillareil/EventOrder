    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        <div class="card-body p-4 p-md-5 bg-white border-bottom">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
                <div>
                    <h5 class="fw-bold text-dark mb-1">Statement of Account</h5>
                    <p class="text-muted small mb-0">Track guest's aging balances, verify incoming deposits, and manage master guest ledger accounts.</p>
                </div>
                ...
                <table class="table table-borderless table-hover align-middle mb-0">
                    <thead class="sticky-top bg-white border-bottom align-middle" style="z-index: 5; height: 52px;">
                        <tr>
                            ...
                            <th class="text-secondary fw-bold fs-7">Doc No.</th>
                            <th class="text-secondary fw-bold fs-7">Guest / Company</th>
                            <th class="text-secondary fw-bold fs-7">Function</th>
                            <th class="text-secondary fw-bold fs-7">Total Charges</th>
                            <th class="text-secondary fw-bold fs-7">Credits Paid</th>
                            <th class="text-secondary fw-bold fs-7">Balance Due</th>
                            <th class="text-secondary fw-bold fs-7">Aging Status</th>
                        </tr>
                    </thead>
                    <tbody id="load_UserAccountLists">
                        ...
                        <!-- Empty State View -->
                        <tr>
                            <td colspan="8" class="py-5 text-center" onclick="loadSampleSoa()">
                                <div class="mb-3">
                                    <div class="d-inline-flex align-items-center justify-content-center p-3">
                                        <i class="bi bi-file-earmark-spreadsheet text-muted fs-3"></i>
                                    </div>
                                </div>
                                <h6 class="fw-bold text-dark mb-1">No Accounts found</h6>
                                <p class="text-muted small mb-0">No folios records available.</p>
                            </td>
                        </tr>
